...
export default {
  ...
  methods: {
          ...
          axios
            ...
            .then(response => {
              ...
              if (status == "200") {
                this.$message({
                  message: h("p", null, [
                    h("i", { style: "color: teal" }, "Sub-Categoria Agregada!")
                  ]),
                  type: 'success'
                });
            ...
            this.$message.error({
                message: h("p", null, [
                h("i", { style: "color: red" }, 'Ingrese un Nombre de Sub-Categoria')
                ])
            });
          return false;
        }
          ...
          axios
            ...
            .then(response => {
              ...
              if (status == "200") {
                this.$message({
                  message: h("p", null, [
                    h("i", { style: "color: teal" }, "Sub-Categoria Eliminada!")
                  ]),
                  type: 'success'
                });
                this.formInline.name = "";
    ...
    handleEdit(row){
        this.$prompt('Nombre Sub-Categoria', 'Edición de Sub-Categorias', {

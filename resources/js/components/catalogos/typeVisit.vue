...
export default {
  ...
  methods: {
          ...
          axios
            ...
            .then(response => {
              ...
              if (status === true) {
                this.$message({
                  message: h("p", null, [
                    h("i", { style: "color: teal" }, "Agregado con Exito!")
                  ]),
                  type: 'success'
                });
                ...
                this.$message.error({
                  message: h("p", null, [
                    h("i", { style: "color: red" }, 'Tipo Visita Existente')
                  ])
                });
                 this.fullscreenLoading = false;
              }
    ...
    handleEdit(row){
        this.$prompt('Nombre', 'Formulario de Edición', {

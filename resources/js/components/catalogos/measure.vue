...
export default {
    ...
    return {
      ...
      rules: {
        name: [
          {
            required: true,
            message: "Ingrese Nombre de la Medida",
            trigger: "blur"
          }
        ]
      },
  ...
  methods: {
    ...
    onSubmit(formName) {
        ...
        if (valid) {
          ...
          axios
            ...
            this.$message.error({
                message: h("p", null, [
                h("i", { style: "color: red" }, 'Ingrese un Nombre de Medida')
                ])
            });
          return false;
        }
          ...
          axios
            ...
            .then(response => {
              ...
              if (status == "200") {
                this.$message({
                  message: h("p", null, [
                    h("i", { style: "color: teal" }, "Medida Eliminada!")
                  ]),
                  type: 'success'
                });
                this.formInline.name = "";
    ...
    handleEdit(row){
        this.$prompt('Nombre Medida', 'Edición de Medida', {
